  ...
  return (
    <div id='work' className="w-full px-[12%] py-5 scroll-mt-20">
      ...
      <section className="flex flex-wrap justify-center items-center gap-10">
        ...
        <div className="w-[350px] bg-[#fcf4ff] dark:bg-gray-800 pb-4 hover:scale-[1.02] border border-gray-400 dark:border-gray-600 rounded-lg
                        hover:shadow-[4px_4px_0_#000] cursor-pointer hover:bg-[#fcf4ff] dark:hover:bg-gray-700 hover:-translate-y-1 duration-500">
          <img className="w-[350px] mb-5 rounded-t-lg" src="/moove.png" alt="" />
          <div className="px-3">
            <h1 className="text-[18px] font-bold text-black dark:text-white">Moove Homepage Clone</h1>
            <p className="text-gray-700 dark:text-gray-300 font-bold">Tech Stack: HTML, CSS</p>
          </div>
          <div className="px-3 py-4 flex items-center gap-3">
            <a className="bg-black text-[#fcf4ff] p-2 font-bold rounded-[5px]" href="https://github.com/Toyosi-james/Toyosi-james-moove-responsive-website." target="_blank" rel="noopener noreferrer">View Project</a>
            <a className="border-2 border-gray-400 dark:border-gray-600 p-2 rounded-[5px] font-bold" href="https://toyosi-james.github.io/Toyosi-james-moove-responsive-website./" target="_blank" rel="noopener noreferrer">Live Demo</a>
          </div>
        </div>
